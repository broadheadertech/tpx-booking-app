...
class AIBarberService {
  ...
  async generatePersonalizedRecommendations(userPreferences, uploadedImage = null) {
    ...
    const systemPrompt = `You are Fvcundo AI Barber Assistant, an expert hair styling consultant with years of experience in men's grooming and barbering. Your specialty is providing personalized haircut recommendations based on comprehensive head and hair analysis.
