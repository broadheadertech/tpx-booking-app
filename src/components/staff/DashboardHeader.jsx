...
import { Scissors, User, Settings, LogOut, Monitor, CreditCard } from 'lucide-react'
        ...
        <div className="flex justify-between items-center py-8">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3">
              <Link
                to="/staff/pos"
                className="bg-green-500/20 backdrop-blur-sm rounded-2xl flex items-center space-x-2 px-4 py-3 hover:bg-green-500/30 transition-all duration-300 border border-green-500/30 group"
                title="POS Mode"
              >
                <CreditCard className="w-5 h-5 text-green-300 group-hover:text-green-200 transition-colors duration-300" />
                <span className="text-green-300 group-hover:text-green-200 font-semibold text-sm transition-colors duration-300">POS Mode</span>
              </Link>
