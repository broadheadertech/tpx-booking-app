          ...
          <>
            ...
            >
              <motion.div
                ...
                className="relative w-full max-w-2xl transform rounded-3xl shadow-2xl transition-all bg-gradient-to-br from-[#1E1E1E] to-[#2A2A2A] border border-[#333333]/60 pointer-events-auto overflow-hidden"
                style={{ zIndex: 1000000000 }}
              >
                {/* Header */}
                <div className="flex items-center justify-between p-8 border-b border-[#2F2F2F]">
                  ...
                  <button
                    onClick={() => setIsOpen(false)}
                    className="w-10 h-10 rounded-2xl bg-[#2A2A2A] hover:bg-[#FF8C42]/10 flex items-center justify-center transition-colors duration-200"
                    title="Close"
                  >
                ...
                {/* Stats and Actions */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6 px-8">
                  <div className="bg-[#444444]/30 rounded-lg p-3 border border-[#444444]/50 text-center">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200
                        ${activeFilter === option.value
                          ...
                          : 'bg-[#444444]/50 text-gray-300 hover:bg-[#555555]/50 hover:text-white'
                        }`}
                    >
                      {option.label}
                      {option.count > 0 && (
                ...
                {/* Quick actions */}
                <div className="flex items-center justify-between pt-6 border-t border-[#2F2F2F] px-8">
                ...
                <div className="max-h-[50vh] overflow-y-auto custom-scrollbar">
                  {notifications === undefined ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-12 text-gray-400">
                      <div className="p-4 bg-[#444444]/30 rounded-2xl border border-[#444444]/50 mb-4">
                ...
                {/* Footer */}
                <div className="flex items-center justify-between p-8 border-t border-[#2F2F2F]">
                  ...
                  <button
                    onClick={() => setIsOpen(false)}
                    className="px-6 py-2 text-sm font-medium bg-[#2A2A2A] hover:bg-[#FF8C42]/10 text-gray-300 hover:text-[#FF8C42] rounded-2xl transition-colors duration-200 border border-[#333333]/60"
                  >
                    Close
                  </button>
                </div>
