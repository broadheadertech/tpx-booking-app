  ...
  const calculateStats = () => {
    ...
    const thisMonthRevenue = transactions
      .filter((t) => {
        ...
        return (
          transactionDate.toISOString().slice(0, 7) === thisMonth &&
          ...
          stats={[
            {
              ...
              icon: "building",
              subtext: `${stats.activeBranches} active`,
            },
            ...
            },
            {
              ...
              icon: "dollar",
              subtext: `₱${stats.thisMonthRevenue.toLocaleString()} this month`,
            },
    ...
    switch (activeTab) {
      ...
      case "branding":
        return user?.role === "super_admin" ? (
          ...
          <div className="text-center text-gray-400">
            You do not have access to branding management.
          </div>
        );
      ...
      case "emails":
        return user?.role === "super_admin" ? (
          ...
          <div className="text-center text-gray-400">
            You do not have access to email notification settings.
          </div>
        );
