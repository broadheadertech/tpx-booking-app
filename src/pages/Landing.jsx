...
import { Calendar, Scissors, Star, MapPin, Phone, Clock, Users, Award, Shield, ArrowRight, Check, TrendingUp, Heart, Sparkles } from 'lucide-react'
...
const Landing = () => {
  ...
  const testimonials = [
    {
      name: "Miguel Santos",
      rating: 5,
      comment: "Best barbershop experience in the city. Professional service and great atmosphere.",
      initials: "MS",
    ...
    },
    {
      name: "Carlos Rivera",
      rating: 5,
      comment: "Amazing attention to detail. My go-to place for all grooming needs.",
      initials: "CR",
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 shadow-xl border-b border-gray-700/50 sticky top-0 z-50 backdrop-blur-md">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-4">
              <img 
                ...
                className="w-27 h-15 object-contain"
              />
              <div>
                <h1 className="text-2xl font-bold text-white">TPX Barbershop</h1>
                <p className="text-sm text-orange-400 font-medium">Professional Grooming</p>
              </div>
            </div>
                ...
                <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 z-40">
                  <div className="bg-white/90 backdrop-blur-xl px-6 py-4 rounded-2xl shadow-2xl border border-white/50 flex items-center gap-3 hover:bg-white/95 transition-all duration-300">
                    ...
                    <div className="border-l border-gray-300 pl-3">
                      ...
                      <span className="text-gray-600 text-sm ml-1">2,500+ reviews</span>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <button
                      ...
                      className="w-full bg-gray-900 text-white py-3 rounded-lg font-semibold hover:bg-orange-600 transition-colors duration-200"
                    >
                      Book Service
                    </button>
                  </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience seamless booking, AI-powered style recommendations, and manage your grooming appointments on the go.
            </p>
          </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Schedule appointments instantly with our intuitive booking system. View available slots and book your preferred time.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">AI Style Assistant</h3>
                    <p className="text-gray-600">Get personalized style recommendations powered by AI. Advanced head shape and hair analysis for perfect suggestions.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Personal Dashboard</h3>
                    <p className="text-gray-600">Track your bookings, manage vouchers, and access shop information all in one convenient dashboard.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Enjoy a premium barbershop experience with professional service tracking and loyalty rewards.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="flex justify-center items-center space-x-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 font-medium mb-2">Scan to download</p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Located in the heart of Quezon City, our modern barbershop offers a premium grooming experience in a comfortable, professional environment.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Main Street, Quezon City</p>
                  </div>
                </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 mb-8">
                Join over 2,500 satisfied customers who trust TPX Barbershop for their grooming needs.
              </p>
              
              <div className="space-y-3 mb-8">
                {['Professional expert barbers', 'Premium quality products', 'Clean, modern facilities', 'Convenient online booking'].map((benefit, index) => (
          ...
          <div className="text-center">
            <div className="flex items-center justify-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-orange-500 text-sm font-medium">Professional Grooming Services</p>
              </div>
            </div>
